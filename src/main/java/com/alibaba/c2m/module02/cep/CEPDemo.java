package com.alibaba.c2m.module02.cep;
...
public class CEPDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Pattern<Tuple3<String, String, Long>, Tuple3<String, String, Long>> cepPattern = Pattern.<Tuple3<String, String, Long>>begin(
            "start")
            .where(new SimpleCondition<Tuple3<String, String, Long>>() {
                ...
                public boolean filter(Tuple3<String, String, Long> value) throws Exception {
                    return Objects.equals(value.f1, "帽子");
                }
            }).next("middle")
            .where(new SimpleCondition<Tuple3<String, String, Long>>() {
                @Override
        ...
        CEP.pattern(source,cepPattern).select(new PatternSelectFunction<Tuple3<String,String,Long>,String>() {
            @Override
